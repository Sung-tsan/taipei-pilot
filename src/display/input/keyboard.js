...
export class KeyboardInput {
  ...
  /**
   * @param {number} dt
   * @returns {{ r:number, p:number, th:number, gearUp:boolean }}
   */
  read(dt) {
    const d = this._down;
    ...
    return { r, p, th: this.th, gearUp: this.gearUp };
  }
}

const KEYS = new Set(['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'KeyW', 'KeyS', 'Space', 'KeyX', 'KeyG']);
