...
## 當前 baseline（最後更新 2026-06-13，含 v1.1-0）

| 檢查 | 指令 | 期望 |
|------|------|------|
| 型別 | `npm run typecheck` | 0 errors |
| 單元 | `npm test`（vitest） | **77 passed**（7 files；+hud-slots、+protocol 擴充、+flight-model 複雜操控） |
| 整合 | `npm run e2e`（playwright） | **8 passed**（connect ×6 + flight ×2） |
